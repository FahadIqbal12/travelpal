...
import { Flight, GloboAI, Main } from '@/context';
...
const ai = () => {
 ...
 // console.log(f.flight)
  ...
  const questions = ['Give me some more information about the flight',
    'How much should I pack for 10 day trip to Switzerland?',
  ...
  const handleAiResponse = async () =>{
    setLoader(true)
    await axios.post(`${URL}/inflight-ai`,{
      prompt:input,
      booking:f.flight
    }).then((res)=>{
      let result = res.data
